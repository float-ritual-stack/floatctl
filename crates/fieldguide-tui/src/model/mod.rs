            ...
            sections: vec![
                Section {
                    ...
                    entries: vec![
                        Entry {
                            ...
                            description:
                                "Pattern matching on message content, user masks, channel context".to_string(),
                            signals: vec![
                                "on *:TEXT:".to_string(),
                        ...
                        Entry {
                            ...
                            description:
                                "Message tossing between channels, context preservation".to_string(),
                            signals: vec![
                ...
                Section {
                    ...
                    entries: vec![Entry {
                        ...
                        description:
                            "Pattern matching on payload content, user context, operational semantics".to_string(),
                        signals: vec![
                        ...
                        protocol:
                            "Examine payload content, user context, channel patterns, temporal conditions"
                                .to_string(),
                    }],
                },
            ],
